...
var urlPrefix = "192.168.0.73:8080";
...
function getChat(chatId) {
    $.ajax({
        type: "GET",
        url: `http://${urlPrefix}/get-chat/${chatId}`,
...
function createChat(chatName, block, area) {
    ...
    $.ajax({
        type: "POST",
        url: `http://${urlPrefix}/create-chat`,
        data: json,
...
function doAddPrivateChat(chatName, block, area) {
    ...
    $.ajax({
        type: "POST",
        url: `http://${urlPrefix}/create-private-chat`,
        data: json,
        contentType: "application/json",
        success: () => closeButtonEvent(block, area)
    });
...
function registerUser() {
    $.ajax({
        type: "POST",
        url: `http://${urlPrefix}/create-client`,
        data: {
            name: author.name
        },
        success: function (response) {
